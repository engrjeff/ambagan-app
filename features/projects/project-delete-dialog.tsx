...
export function ProjectDeleteDialog({ projectName, projectId }: { projectName: string; projectId: string }) {
  ...
  return (
    <Card className="bg-background border-red-700">
      <CardHeader className="border-b">
        ...
        <CardDescription>
          Completely delete this project and all its related records from the system&apos;s database.
        </CardDescription>
      </CardHeader>
      <CardFooter className="justify-end">
        <AlertDialog>
          <AlertDialogTrigger asChild>
            <Button className="bg-red-700 text-white hover:bg-red-600">Delete Project</Button>
          </AlertDialogTrigger>
          <AlertDialogContent>
            <AlertDialogHeader>
